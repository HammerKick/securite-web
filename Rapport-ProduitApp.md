...
- Injection SQL : avec php bin/console dbal:run-sql 'SELECT \* FROM \"order\" WHERE id = 1 OR 1=1'
  ...
  ***
  ...
  Bon le mot de passe est chiffré au moins... par contre on récupère les numéros de téléphone, une information sensible et ce avec une vraie injection SQL : c'est une faille critique à corriger
